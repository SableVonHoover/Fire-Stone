...
export default class FighterCard1 extends React.Component {
  constructor() {
    super();
    this.state = {
      myTotalHealth: 999,
  ...
  render() {
    let myDmg = this.state.myDamage;
    let enNewHp = this.state.enTotalHealth - myDmg;
    let enBarWidth = (enNewHp / this.state.enTotalHealth) * 100;
    let enDmgWidth = (myDmg / this.state.enCurrentHealth) * 100;
